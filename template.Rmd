...
title: STA4026Z Neural Network Assignment: Hitting the wall - A runner’s guide
date: "`r Sys.Date()`"
author:
  - name: Jing Yeh
...
abstract:  In this report, we explored the effects of carbonhydrate, fluid intakes and average speed maintained by runners of both genders on whether they experience the common "hitting the wall" phenomanon during their runs. We use a split-brain neural network that models diet and runner's profile separately.
  
keywords: Neural Networks, Sports Science, Atheletics Data Analytics 
